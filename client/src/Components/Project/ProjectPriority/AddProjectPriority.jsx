...
const AddProjectPriority = () => {
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("/api/v1/projectPriority/create-projectPriority", { name, description }, {
        headers: {
...
export default AddProjectPriority;